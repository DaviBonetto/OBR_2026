...
def main():
    # model = YOLO('../../ai_models/ball_zone_s/ball_detect_s_edgetpu.tflite', task='detect')  # old model
    model = YOLO('../../ai_models/ball_zone_s/ball_detect_s_edgetpu.tflite', task='detect')
