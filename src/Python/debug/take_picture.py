...
def main(line: bool, silver: bool):
    ...
    # model = YOLO('../../ai_models/silver_zone_entry/silver_classify_s.onnx', task='classify') # old model
    model = YOLO('../../ai_models/test/silver_zone_entry/silver_classify_s.onnx', task='classify')
